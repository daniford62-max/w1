...
<body>
    ...
    <script>
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at CHILD PORNOGRAPHY WEBSITE for $649.70 Via Apple Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Apple Support +1-888-909-0076 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
